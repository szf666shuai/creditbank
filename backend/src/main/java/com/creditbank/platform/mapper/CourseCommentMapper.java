...
public interface CourseCommentMapper extends BaseMapper<CourseComment> {
    ...
    @Select("""
            SELECT cc.id, cc.course_id AS courseId, cc.user_id AS userId, cc.parent_id AS parentId,
                   ...
                   u.avatar,
                   cc.content, cc.like_count AS likeCount, cc.create_time AS createTime
            ...
            LIMIT #{limit}
            """)
    List<CourseCommentVO> listByCourseId(@Param("courseId") Long courseId, @Param("limit") int limit);
}
