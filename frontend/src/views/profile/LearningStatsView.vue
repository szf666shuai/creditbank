...
function renderCharts() {
  ...
  lineChart.setOption({
    ...
    tooltip: { trigger: 'axis', formatter: (params: unknown) => formatLineTooltip(params) },
...
function formatLineTooltip(params: unknown) {
...
<template>
  ...
  >
    ...
    <el-empty
      ...
      class="page-empty"
      :image-size="80"
      description="所选日期范围内暂无学习数据"
    />

    <div v-else-if="stats.length > 0" class="charts-wrap">
